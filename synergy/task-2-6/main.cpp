...
int main() {
    ...
    string animals[] = {"Monkey", "Rooster", "Dog", "Pig", "Rat", "Ox", "Tiger", "Rabbit", "Dragon", "Snake", "Horse",
                        "Sheep"};
    int animalIndex = (year - 4) % 12;
    cout << "Eastern calendar year: " << animals[animalIndex] << endl;

    string signs[] = {"Aquarius", "Pisces", "Aries", "Taurus", "Gemini", "Cancer", "Leo", "Virgo", "Libra", "Scorpio",
